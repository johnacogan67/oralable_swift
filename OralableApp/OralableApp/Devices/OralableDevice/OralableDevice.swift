...
class OralableDevice: NSObject, BLEDeviceProtocol {
    ...
    /// Cancel any pending async continuations to prevent hangs on disconnect or discovery timeout.
    func cancelPendingContinuations(error: Error = DeviceError.connectionFailed("Device disconnected")) {
