...
final class NRFConnectBLELogger {
    ...
    func discoveredCCC(for characteristicUUID: String) {
        log(source: .connectedDevice, level: .application, line: "Client Characteristic Configuration found for \(characteristicUUID)")
    }

    func characteristicHasNoDescriptors(_ characteristicUUID: String) {
        log(source: .connectedDevice, level: .debug, line: "No descriptors found for \(characteristicUUID)")
    }
